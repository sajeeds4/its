...
const Home: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Aethrix Systems | Long Island IT Services & Solutions</title>
        <meta name="description" content="Aethrix Systems provides comprehensive IT services including web development, ERP solutions, cloud services, and AI automation for Long Island businesses." />
        <meta property="og:title" content="Aethrix Systems | Long Island IT Services" />
        <meta property="og:description" content="Comprehensive IT services for Long Island businesses - Web Development, ERP, Cloud, AI Automation" />
        <meta property="og:type" content="website" />
        <meta name="keywords" content="IT services Long Island, web development, ERP solutions, cloud services, AI automation, networking, Aethrix Systems" />
      </Helmet>
      <div className="home">
  {/* Hero Section (Slider) */}
  <Hero />
        ...
        <div className="container">
          ...
          <div className="services-grid">
            {[
              ...
              <div className="service-card card" key={s.id}>
